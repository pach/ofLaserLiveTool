...
//    }
    float y1, y2, y3;
    for (int i=0 ; i<nbPoint ; i++){
        y1 = sin((float)i*sin11.freq/nbPoint+derivativeTime*sin11.speed)*sin11.height;
        y2 = sin((float)i*sin12.freq/nbPoint+derivativeTime*sin12.speed)*sin12.height;
        y3 = sin((float)i*sin13.freq/nbPoint+derivativeTime*sin13.speed)*sin13.height;
        polylines[0].addVertex((float)i/(float)nbPoint, (y1+y2+y3)-posY);
        y1 = sin((float)i*sin21.freq/nbPoint+derivativeTime*sin21.speed)*sin21.height;
        y2 = sin((float)i*sin22.freq/nbPoint+derivativeTime*sin22.speed)*sin22.height;
        y3 = sin((float)i*sin23.freq/nbPoint+derivativeTime*sin23.speed)*sin23.height;
